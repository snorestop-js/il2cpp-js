  ...
  setValue(value: any) {
    ...
    switch (type.getUnderlyingType()) {
      ...
      case Il2CppTypeEnum.IL2CPP_TYPE_U1: {
        ...
        return __IL2CPP.il2cpp_field_set_value(this.parent.getPointer(), this.ptr, buffer);
      }
      case Il2CppTypeEnum.IL2CPP_TYPE_I1: {
        const buffer = __IL2CPP.snorestop_create_buffer_readonly(1);
      ...
      case Il2CppTypeEnum.IL2CPP_TYPE_U4:{
        const buffer = __IL2CPP.snorestop_create_buffer_readonly(4);
      ...
      case Il2CppTypeEnum.IL2CPP_TYPE_I8:
      case Il2CppTypeEnum.IL2CPP_TYPE_R8:
        throw new Error("Cannot write 64-bit types.");
      case Il2CppTypeEnum.IL2CPP_TYPE_STRING: {
        const buffer = __IL2CPP.snorestop_create_buffer(4);
        new Uint32Array(buffer)[0] = (value as Il2CppString).getPointer();
        return __IL2CPP.il2cpp_field_set_value(this.parent.getPointer(), this.ptr,buffer);
        break;
      }
      case Il2CppTypeEnum.IL2CPP_TYPE_SZARRAY:
      case Il2CppTypeEnum.IL2CPP_TYPE_ARRAY:
        const buffer = __IL2CPP.snorestop_create_buffer(4);
        new Uint32Array(buffer)[0] = (value as Il2CppArray<any>).getPointer();
        return __IL2CPP.il2cpp_field_set_value(this.parent.getPointer(), this.ptr,buffer);
      case Il2CppTypeEnum.IL2CPP_TYPE_CLASS: {
        const buffer = __IL2CPP.snorestop_create_buffer(4);
        new Uint32Array(buffer)[0] = (value as Il2CppObject).getPointer();
        return __IL2CPP.il2cpp_field_set_value(this.parent.getPointer(), this.ptr,buffer);
      }
      default:
        throw new Error(`Cannot write ${Il2CppTypeEnum[type.getUnderlyingType()]} type.`);
    }
  }
}
